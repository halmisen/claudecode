...
from strategies.dojo1_v2 import DojiAshiStrategyV2
...
def main():
    ...
    path4h = r"D:\\BIGBOSS\\backtester\\backtests\\data\\BTCUSDT\\BTCUSDT_4h_merged.csv"

    df4h = load_binance_csv_to_pandas(path4h)
    ...
    try:
        if _impspec.find_spec("backtrader_plotting") is not None:
            try:
                ...
                html_path = plots_dir / f"dojo1_v2_{ts}.html"
        ...
        try:
            ...
            for fset in figs:
                for fig in fset:
                    png_path = plots_dir / f"dojo1_v2_{ts}_{idx}.png"
