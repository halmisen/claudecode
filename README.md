...
│   ├── run_doji_ashi_strategy_v5.py  # v5运行器 (推荐)
│   ├── data/            # 市场数据
...
2. **Python 转换**: 参考 [策略转换指南](./deprecated_v4/doji_ashi_strategy_v4_guide.md)
3. **标准化实现**: 使用项目标准导入模板
4. **回测验证**: 运行完整回测和可视化
...
### 历史文档 (参考)
- **🎯 [Doji Ashi v4 指南](./deprecated_v4/doji_ashi_strategy_v4_guide.md)** - V4策略详解 (已弃用)
...
**🔗 快速链接**: [文档索引](./docs/README.md) | [v4策略指南](./deprecated_v4/doji_ashi_strategy_v4_guide.md) | [快速入门](./docs/backtrader-quickstart.md)
